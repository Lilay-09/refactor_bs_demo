...
class MerchantManagementController extends Controller
{
    ...
    public function getOneMerchant(Request $req){
        ...
        ->where('account_type',$this->userClass)
        ->with(['bank_accounts:id,bank_name,bank_number,account_name,user_id,is_primary','shops:id,owner_id,name_en as shop_name_en,name_km as shop_name_km,phone,est_pcs,address,city,district,commune'])
