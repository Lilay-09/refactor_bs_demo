...
class VerifyBatchPaymentJob implements ShouldQueue
{
     ...
     */
    public function __construct($transactionId,$topic,$maxRetries=5)
    {
    ...
    public function handle()
    {
        ...
        if ($response->error) {
            ...
            $newData['error'] = false;
            PaywayServiceImpl::sendDriverPaymentTransaction($newData, $this->topic,'driverPayViaDriverApp');
        }
